...
// GetKiroModels returns the Kiro model definitions for models not returned by upstream API.
// These are custom model mappings that need to be statically defined.
	...
	return []*ModelInfo{
		{
			...
			Description:         "Kiro Claude Sonnet 4.6 (2025-02-17)",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 32000, ZeroAllowed: true, DynamicAllowed: true},
		},
		...
		},
		{
			...
			Description:         "Kiro Claude Sonnet 4.6 with extended thinking (2025-02-17)",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 32000, ZeroAllowed: true, DynamicAllowed: true},
		},
