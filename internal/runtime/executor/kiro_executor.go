...
func (e *KiroExecutor) mapModelToKiro(model string) string {
	modelMap := map[string]string{
		...
		"kiro-claude-sonnet-4-6":                   "claude-sonnet-4-6-20260217",
		"kiro-claude-sonnet-4-6-20260217":          "claude-sonnet-4-6-20260217",
		"kiro-claude-sonnet-4-6-thinking":          "claude-sonnet-4-6-20260217-thinking",
		"kiro-claude-sonnet-4-6-20260217-thinking": "claude-sonnet-4-6-20260217-thinking",
